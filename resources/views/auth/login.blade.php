            ...
            <div class="col-lg-4 text-light">
                ...
                <form action="/login" method="post">
                    ...
                    <div class="mb-4 text-center">
                        <input type="email" class="form-control text-center" placeholder="Email address" name="email"
                    ...
                    <div class="text-center">
                        <span>Don't have account. <a href="/register" class="fw-bold text-decoration-none">Create
                                now</a></span>
                    </div>
                </form>
            </div>
